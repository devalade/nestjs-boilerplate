...
export class Message implements MessageContract {
   ...
   */
  public htmlView(template: string, data?: unknown): this {
   ...
   */
  public textView(template: string, data?: unknown): this {
   ...
   */
  public watchView(template: string, data?: unknown): this {
